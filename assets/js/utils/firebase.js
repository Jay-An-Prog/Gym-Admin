...
import { getDatabase, ref, query, orderByChild, equalTo, onValue, update, remove } from "https://www.gstatic.com/firebasejs/11.0.1/firebase-database.js";
...
// Exports
export { app, auth, provider, db, rtdb, ref, query, orderByChild, equalTo, onValue, update, remove };
